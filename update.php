...
$gender=$_POST['sex'];
	...
	$st="update users set pass='$pass',prof='$prof',gender='$gender'
	where email='$email'";
	$stquery=mysql_query($st);
...
<hr>
<h2 style="color:white;">Edit My profile</h2>
<hr>

<form method="post" action="">
<h2>Email : </h2><h2><input type="email" class="txt" value="<?php echo $uemail?>" readonly name="email"></h2>
<p style="color:red;"> <strong>Note:</strong>Email cannot be changed</p>
<h2>Password : </h2><h2><input type="text" class="txt" value="<?php echo $upass?>" name="password"></h2>

<h2> Select Professional : </h2><h2><select class="txt" name="prof">
<option selected value="<?php echo $uprof?>"><?php echo $uprof?></option>
...
<h2><input type="radio" class="txt" value="Male" name="sex">Male</h2>
<h2><input class="txt" value="Female" type="radio" name="sex">Female</h2>
<input type="submit" onclick="" value="      Update     "class="txt1" name="update">
</form>
</body>
</html>